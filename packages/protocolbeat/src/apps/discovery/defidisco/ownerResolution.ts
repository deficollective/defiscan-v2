 ...
 *
 * This module provides unified path expression resolution for both frontend and backend.
...
/**
 * Data access implementation for UI (works with API response format)
 */
export class UIContractDataAccess implements IContractDataAccess {
